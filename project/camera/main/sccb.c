...
struct reg_raw defcfg_table[] = {
   {0xff, 0x00},     //0xff set to 0x00
   {0x2c, 0xff},
   {0x2e, 0xdf},
   {0xff, 0x01},     //0xff set to 0x01
   {0x3c, 0x32},//
   {0x11, 0x81},     //BIT[5:0] CLK=XVCLK/(bit[5:0]+1)
   {0x09, 0x02},
   {0x04, 0x28},
   {0x13, 0xe5},
   {0x14, 0x48},
   ...
   {0xd7, 0x03},
   {0xd9, 0x10},
   {0xd3, 0x01},// set 1/12 XCLK default 0x82,
   {0xc8, 0x08},
   {0xc9, 0x80},//
   {0x7c, 0x00},
   {0x7d, 0x00},
...
struct reg_raw yuv442_cfg_table[] = {
    {0xFF,    0x00},
    {0x05,    0x00},
    {0xDA,    0x00},       //0x00 for High byte first YUYV 0x01 Low byte first UYVY 0x00 µÄÐ§¹û×îºÃ
    {0xD7,    0x03},       //{0xD7,    0x01},
