...
static const touch_pad_t button[TOUCH_BUTTON_NUM] = {
    TOUCH_PAD_NUM8,     // 'PLAY' button.
    TOUCH_PAD_NUM2,     // 'VOLUME+' button.
    TOUCH_PAD_NUM9,     // 'VOLUME-' button.
    TOUCH_PAD_NUM11,    // 'NETWORK' button.
    TOUCH_PAD_NUM3,    //  'PHOTO' button.
    TOUCH_PAD_NUM13,    // 'RECORD' button
    TOUCH_PAD_NUM1,    // Guard ring for waterproof design. 
...
static void touchsensor_filter_set(touch_filter_mode_t mode)
{
    ...
    touch_filter_config_t filter_info = {
            ...
            .hysteresis_thr = 3,    // 9.4%
            .noise_thr = 0,         // 37.5%
            .noise_neg_thr = 0,     // 37.5%
...
void touch_init()
{
    ...
    touch_pad_waterproof_t waterproof = {
            .guard_ring_pad = button[6],   // If no ring pad, set 0;
